    ...
    return (
        <div className='qui-somme-nous d-flex flex-column justify-content-around align-items-center'>
            ...
            <div className='mb-4' style={{ width:'80%' }}>
                ...
                <p>La Maison des Associations de Saint-Benoît est un lieu de conseils et de formations pour les associations dans 
            ...
            <div className='mb-4' style={{ width:'80%' }}>
                <h3>Espace d’accueil, de rencontres et d’échanges</h3>
                <p>Nous contribuons à aider les associations à entrer en relation avec d’autres, en les aidant à se faire connaître 
                et à valoriser leurs actions auprès du public. Nous soutenons l’émergence de projets inter-associatifs.</p>
            </div>
            <div className='mb-4' style={{ width:'80%' }}>
                <h3>Lieu ouvert aux dynamiques locales</h3>
            ...
            <div className='mb-4' style={{ width:'80%' }}>
                <h3>Maison des Associations de Saint-Benoît</h3>
