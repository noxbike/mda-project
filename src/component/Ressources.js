        ...
        <div className='pt-4 col-md-10 ml-auto mr-auto'>
            ...
            <div className='pt-4 col-12 col-md-6 col-lg-4' style={{ boxShadow: '1px 1px 25px rgba(0,0,0,.2)' }}>
                ...
                <ul className='pb-4' style={{ listStyle: 'none' }}>
                    ...
                    <li><a href='http://mda-saintbenoit.re/ressources/Fiche de besoins  volontaire SCV 2020.pdf' target='__blank'>&gt; FICHES MISSIONS SERVICE CIVIQUE 2020</a></li>
                    <li><a href='http://mda-saintbenoit.re/ressources/FICHE de Mission SC2020.pdf' target='__blank'>&gt; FICHES DE BESOINS VOLONTAIRE SERVICE CIVIQUE</a></li>
                </ul>
            </div>
        </div>
    )
